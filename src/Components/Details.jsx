...
const Details = () => {
    ...
    const DeleteHandler = () => {
      ...
      return recipe ? (
      <div id='Details' className="w-[80%] m-auto p-5">
        <Link to="/recipe" className="text-3xl ri-arrow-left-line"></Link>
        <div id='container' className=" w-full flex min-h-72 mt-3">
          <div id='dets' className="dets w-[50%] p-[3%] shadow">
            ...
            <div className="flex justify-between py-10 px-5">
              <Link
                ...
                className="text-orange-400 border-orange-400 border py-2 px-5"
              >
                Update
              </Link>
              <button
          ...
          <div id='desc' className="desc w-[50%] px-[5%] py-[3%] overflow-auto">
