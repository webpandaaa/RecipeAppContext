  ...
  return (
    <div>
      <div className='w-full border-b-2 border-zinc-500 flex justify-center' >
        <img id='first' className='w-[13%] mb-8' src="/images/about.png" alt="" />
      </div>
      <div id='acnt' className='w-[100%]  flex mt-[5%] border-b-2 border-zinc-500 pb-[5%]'>
        <div id='aleft' className='w-[50%]  flex justify-center'>
        ...
        <div id='aright' className='w-[50%] flex flex-col items-center p-5  '>
