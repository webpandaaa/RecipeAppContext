...
const Contact = () => {
  return (
    <div>
      <div id='con' className='w-full border-b-2 border-zinc-500 flex justify-center' >
        <img id='conimg' className='w-[13%] mb-8' src="/images/touch.png" alt="" />
      </div>
      <div id='concnt' className='w-[100%]  flex mt-[5%] border-b-2 border-zinc-500 pb-[5%]'>
        <div id='conl' className='w-[50%]  flex justify-center'>
        ...
        <div id='conr' className='w-[50%] flex flex-col items-start p-5   '>
            <p className='text-[18px] font-serif text-zinc-500'>For Any Inquiries Contact Me</p>
            <div id='conform' className='mt-10 flex'>
      ...
      <div id="miss" className='w-full border-b-2 border-zinc-500 flex flex-col justify-center items-center'>
        ...
        <div id='afoot' className='w-[100%] flex justify-center mt-5'>
